...
import com.example.ProiectDistributedSystems.service.RemoteServiceImplementation;
import com.example.ProiectDistributedSystems.service.RemoteServicesInterface;
...
public class NormalUserController {
    ...
    public NormalUserController(UserRepository userRepository, DeviceRepository deviceRepository, SensorRepository sensorRepository, SensorReadingsService sensorReadingsService, LogRepository logRepository) {
    ...
    @Bean(name = "/user/rpc/remoteService")
    public JsonServiceExporter jsonServiceExporter() {
        JsonServiceExporter exporter = new JsonServiceExporter();
        exporter.setService(new RemoteServiceImplementation(logRepository, deviceRepository, sensorRepository));
        exporter.setServiceInterface(RemoteServicesInterface.class);
        return exporter;
    }
